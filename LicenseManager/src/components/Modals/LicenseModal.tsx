...
import { licenseForm, RootState } from "../../types";
import { useSelector } from "react-redux";
import { toast } from "react-toastify";
import { AddIcon } from "@chakra-ui/icons";

function LicenseModal({ onSave }: { onSave: (data: licenseForm) => void }) {
    const { categories, vendors, managers, domains } = useSelector(
            ...
            <Modal isOpen={isOpen} onClose={onClose} size={"xl"}>
                ...
                <ModalContent width={"1000px"}>
                    ...
                    <ModalBody>
                        ...
                        <FormControl
                            isInvalid={!!errors["Vendor.vendor_id"]}
                            mt={4}
                        >
                            ...
                            <FormErrorMessage>
                                {errors["Vendor.vendor_id"]}
                            </FormErrorMessage>
                        </FormControl>

                        <FormControl
                            isInvalid={!!errors["Category.category_id"]}
                            mt={4}
                        >
                        ...
                        <FormControl
                            isInvalid={!!errors["Manager.manager_id"]}
                            mt={4}
                        >
                            ...
                            <FormErrorMessage>
                                {errors["Manager.manager_id"]}
                            </FormErrorMessage>
                        </FormControl>

                        <FormControl
                            isInvalid={!!errors["Domain.domain_id"]}
                            mt={4}
                        >
